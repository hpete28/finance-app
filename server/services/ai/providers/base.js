...
function buildTransactionPrompt({ categories, modelTransactions, includeAmount = false }) {
  ...
  return [
    ...
    '- merchant_insight: short AI-inferred merchant identity/context (what this business likely is), or null if unknown',
    '- confidence: number between 0 and 1',
    '- reason: concise explanation of why category was chosen',
    '',
    'Do not invent category names. Use null if unsure.',
    'You may use general world knowledge for merchant identity, but if uncertain say "possible" or "unknown".',
    '',
    'Output schema:',
    '{"suggestions":[{"transaction_id":"...","category_name":"...|null","tags":["..."],"merchant_name":"...|null","merchant_insight":"...|null","confidence":0.0,"reason":"..."}]}',
    '',
